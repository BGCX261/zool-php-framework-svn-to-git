...
namespace zool\vendor\addendum;
...
class Addendum {
    ...
    private static function checkRawDocCommentParsingNeeded() {
        if(self::$rawMode === null) {
            $reflection = new \ReflectionClass('zool\\vendor\\addendum\\Addendum');
    ...
    public static function resolveClassName($class) {
        ...
        $matcher = false;
        if(!empty($class)){
            $matcher = ANNOTATION_NAMESPACE.$class;
        }
    ...
    private static function getDeclaredAnnotations() {
        if(!self::$annotations) {
            ...
            foreach(get_declared_classes() as $class) {
                if(is_subclass_of($class, 'zool\\vendor\\addendum\\Annotation') || $class == 'zool\\vendor\\addendum\\Annotation') self::$annotations[] = $class;
            }
        }
    ...
    /**
     *
     * @var array prefixes and classes can act in annotation value
     */
    private static $CONST_PREFIXES = [
    'zool\\scope\\' => 'ScopeType'
            ];

    /**
     *
     * @return array key: namespace, value: class name
     */
    public static function getConstPrefixes(){
        return self::$CONST_PREFIXES;
    }
