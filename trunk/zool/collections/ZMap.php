...
/**
 * ZMap implements a collection that takes key-value pairs.
 *
 ...
 * @since 1.0
 */
class ZMap extends ZComponent implements IteratorAggregate,ArrayAccess,Countable
{
	/**
